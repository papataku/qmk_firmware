...
enum planck_keycodes { BACKLIT = SAFE_RANGE, EXT_PLV };
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  | GUI  |Lower/Space  |Raise/Space  | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_2x2u(
    ...
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI,     LOWER,             RAISE,       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
