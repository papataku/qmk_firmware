 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Tab/F2|   Q  |   W  |   E  |   R  |   T  |   Y  |   U  |   I  |   O  |   P  | Enter|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_QWERTY] = LAYOUT_preonic_grid( \
  KC_ESC,  KC_1,    SF_2,    KC_3,    KC_4,    KC_5,    SF_6,    SF_7,    SF_8,    SF_9,    SF_0,    KC_BSPC, \
  FN2_TAB, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ENT,  \
  FN1_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    SF_SCLN, KC_ENT, \
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  FN1_ESC, _______, KC_PSCR, _______, _______, KC_DOT,  KC_PMNS, KC_4,    KC_5,    KC_6,    KC_PAST, _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  SF_GRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6  , KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL, \
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, JP_MINS, JP_PLUS, JP_LCBR, JP_RCBR, JP_PIPE, \
  FN1_ESC, _______, KC_PSCR, _______, _______, _______, _______, KC_HOME, KC_PGUP,  JP_LBRC, JP_RBRC, JP_BSLS, \
  _______, _______, _______, _______, _______, _______, _______, KC_END , KC_PGDN,  JP_UNDS, JP_EQL , _______, \
