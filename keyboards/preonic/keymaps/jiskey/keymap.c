...
[_FUNC1] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, TGL_LOW, _______, _______, TGL_RIS, XXXXXXX, _______, _______, _______  \
),
...
[_FUNC2] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, TGL_LOW, _______, _______, TGL_RIS, _______, _______, _______, _______ \
),
