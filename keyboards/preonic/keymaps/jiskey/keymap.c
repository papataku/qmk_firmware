...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   SFT_QUOT,  \
  KC_LCTL, KC_LGUI, KC_LALT, FUNC2,   M_EMHL,  KC_SPC,  KC_SPC,  M_KHKR,  FN1_SLS, KC_LEFT, KC_DOWN, KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_PCMM, _______, _______  \
),
 ...
 * |      |      |PrintS|      |      |      |   +  |   -  |      |   [  |   ]  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |   *  |   _  | HOME | END  | PGUP | PGDN |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |      |      |             | XXXX | App  |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_preonic_grid( \
  SF_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6  , KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL, \
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, JP_EQL,  KC_PSCR, JP_LCBR, JP_RCBR, KC_DEL, \
  _______, _______, KC_PSCR, _______, _______, _______, JP_PLUS, JP_MINS, _______, JP_LBRC, JP_RBRC, _______, \
  _______, _______, _______, _______, _______, _______, KC_PAST, JP_UNDS, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, \
...
[_FUNC1] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, _______, KC_PSCR, _______, _______, _______, \
 ...
 * |      |      |      |      |      |      |      |      |      |MU_BT2| MUS_U|MU_BT2|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      | XXXX |      |             |      |      | MUS_L| MUS_D| MUS_R|
 * `-----------------------------------------------------------------------------------'
 */
[_FUNC2] = LAYOUT_preonic_grid( \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6  , KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  \
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______, RCS_K,   _______, _______, _______, _______, _______, _______, _______, \
...
[_FUNC2] = LAYOUT_preonic_grid( \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6  , KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, KC_P7,   KC_P8,   KC_P9,    _______, KC_BSPC, \
  _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_PAST, KC_PSLS, KC_P4,   KC_P5,   KC_P6,    _______, _______, \
  _______, KC_F9,   KC_F10,  KC_F11 , KC_F12,  KC_PPLS, KC_PMNS, KC_P1,   KC_P2,   KC_P3,    KC_PEQL, _______, \
  KC_LCTL, KC_LGUI, KC_LALT, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_PCMM, _______, _______ \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, DM_REC1, DM_REC2, DM_RSTP, _______, _______, _______, _______, _______, _______, _______, _______, \
