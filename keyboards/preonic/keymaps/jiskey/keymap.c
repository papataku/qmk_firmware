...
[_RAISE] = LAYOUT_preonic_grid( \
  SF_GRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6  , KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL, \
  _______, KC_F11,  KC_F12,  _______, _______, _______, _______, KC_PSCR, _______, JP_LCBR, JP_RCBR, JP_PIPE, \
  FN1_ESC, _______, _______, _______, _______, KC_PAST, KC_PSLS, KC_HOME, KC_PGUP,  JP_LBRC, JP_RBRC, JP_BSLS, \
  _______, _______, _______, _______, _______, JP_PLUS, JP_MINS, KC_END , KC_PGDN,  JP_UNDS, JP_EQL , _______, \
